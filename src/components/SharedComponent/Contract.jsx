...
export default function Contract() {
  ...
  return (
    <div className="w-full">
      <Row gutter={16}>
        <Col span={12}>
          <div className="text-center mt-5 text-xl font-semibold text-red-600 mb-5">
            Hợp đồng bên đại lý
          </div>
          ...
          <p className="text-center my-1 text-base font-semibold mt-5">
          ...
          >
            ...
            <p className="text-right p-5 pr-10">Xác nhận từ đại lý</p>
            <p className="text-right pr-16 text-xl text-red-500 font-semibold">
              Xác nhận
            </p>
          </div>
        </Col>
        <Col span={12}>
          ...
          <p className="text-center my-1 mt-5 text-base font-semibold">
            Hợp đồng mua bán nhà
          </p>
          ...
          >
            ...
            <p className="p-1">Tình trạng pháp lý: Đầy đủ</p>
            <p className="p-1">Giá trị: {price}đ</p>
            <p className="text-right p-5 pr-10">Xác nhận từ khách mua</p>
            <p className="text-right pr-16 text-xl text-red-500 font-semibold">
              Xác nhận
            </p>
          </div>
